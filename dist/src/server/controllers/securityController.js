...
var securityController = {
    runKubeBench: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var command;
        return __generator(this, function (_a) {
            try {
                command = 'minikube ssh -- kube-bench run --config <cis_yaml_path> --ouput json';
                ...
                (0, child_process_1.exec)(command, function (error, stdout, stderr) {
                    ...
                    var kubeBenchOutput = JSON.parse(stdout);
